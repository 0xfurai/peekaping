...
// Config defines the configuration schema for the Ingester service
type Config struct {
...
// Validate validates the Ingester service configuration
...
// ToInternalConfig converts Ingester config to internal config format
